...
export default function Login() {
  ...
  const handleSubmit = async (e) => {
    ...
    setLoading(true);
    try {
      const res = await fetch("https://algofast-backend.onrender.com/api/auth/login", {
        method: "POST",
      ...
      const userRes = await fetch("https://algofast-backend.onrender.com/api/auth/me", { withCredentials: true, credentials: "include" });
      if (userRes.ok) {
